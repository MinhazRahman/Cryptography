...
public class AttackOnVigenereCiphre {
    ...
    public static Map<Character, Double> generateCipherTextCharacterFrequencyMap(String ciphertext){
        ...
        String lowerCasedCipherText = ciphertext.replaceAll("\\s+", "").toLowerCase();
    ...
    public static void main(String[] args) {
        String cipherText = "VPTHP DQVSA VVGEP ZMEVM CAEKK DTIPF UADTX YGLPF"
                            + "WNGZT SSEIM GVJKG VTUHZ POLPX YOIVU MWKKT UXVXM"
                            + "CPRXU WUJSI TCVHX VFXXU OJMQT ZXYGP JUXZP OHLEJ"
                            + "QVLHW FXMGD MKJPD BRUUI CKKLP AEBXR YINMS IUQMT"
                            + "SEVPH ALVXQ CLCRT LHDII GJJZC RIIXU EJVPT DICNW"
